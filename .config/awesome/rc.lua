...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "e",     function () awful.spawn({"/usr/bin/zsh", "-c", "source ~/.zshrc && emacs"}) end, 
       {description = "launch emacs", group = "launcher"}),

    -- Add volume key controls
    awful.key({}, "XF86AudioMute", function ()
	  awful.util.spawn("amixer -c 1 -D pulse sset Master toggle", false)
    end),
    awful.key({}, "XF86AudioRaiseVolume", function ()
	  awful.util.spawn("amixer -c 1 -D pulse sset Master 5%+", false)
    end),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control", "Mod1" }, "Left",      function (c) c:move_to_screen() end,
       {description = "move to screen", group = "client"}),
    awful.key({ modkey, "Control", "Mod1" }, "Right",      function (c) c:move_to_screen() end,
       {description = "move to screen", group = "client"}),

    -- TODO
    -- Move clients between tags
    ...
    -- 	  c:move_to_tag()
    -- 						       end,
    --    {description = "move to prev tag", group = "client"}),
...
-- {{{ Autostart
awful.spawn.with_shell("compton") -- compositor: transparency, drop shadowing etc..
awful.spawn.with_shell("nitrogen --restore") -- background manager
awful.spawn.with_shell("copyq") -- clipboard manager
-- awful.spawn.with_shell("redshift") -- flux alternative
-- }}}
